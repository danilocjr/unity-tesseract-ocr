...
public class SevenSegmentOCR
{
    ...
    // public Texture2D Bmp;

    // public SevenSegmentOCR(Texture2D bmp)
    // {
    //     Bmp = bmp;
    // }

    // public Texture2D BlackWhite(int type = 0, bool faded = false)
    // {
    //     byte limit = 0;
    //     switch (type)
    //     {
    ...
    //     var img1 = Bmp;
    //     int width1 = img1.width; //PixelWidth;
    //     int height1 = img1.height; //PixelHeight;
